...
function Updating() {
  return (
    <>
      <h1 style={{textAlign:"center" ,border: '2px solid black',backgroundColor:'yellow',marginlift:"15px",borderRadius:'5px',
         width:'600px',
      display:"block",margin:"auto",marginTop:"5px"}}>This is Updating</h1>
      <p>Updating
